...
def autoBackdrop():
    ...
    # Anadir un espacio antes del knob de Font Color
    #space_font_color = nuke.Text_Knob('space_font_color', '', '')
    
    # Nuevo knob para el color de la fuente
    font_color = nuke.ColorChip_Knob('font_color', '')
    font_color.setValue(0xFFFFFF)  # Valor por defecto: blanco
