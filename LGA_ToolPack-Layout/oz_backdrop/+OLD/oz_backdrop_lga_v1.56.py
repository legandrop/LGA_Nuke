...
new_color = '#000000' if color_knob.value() == '#ffffff' else '#ffffff'

# Preservar el formato y actualizar el color
formatted_label = f'<font color="{new_color}">' + node['text'].value() + '</font>'
...
# Actualizar el color en el knob de color actual
