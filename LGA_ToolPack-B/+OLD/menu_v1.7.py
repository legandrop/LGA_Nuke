...
n.addCommand("  Media Manager", "LGA_mediaManager.main()", "ctrl+m", shortcutContext=2, icon=icon_RnW)



# Importar el LGA_mediaPathReplacer
import LGA_mediaPathReplacer 
n.addCommand("  Media Path Replacer", "LGA_mediaPathReplacer.show_search_replace_widget()", "ctrl+alt+m", shortcutContext=2, icon=icon_RnW)
...
n.addCommand("  Show in Explorer", "LGA_showInExplorer.main()", "shift+e", shortcutContext=2, icon=icon_RnW)



# Importar el LGA_showInlFlow
import LGA_showInlFlow 
n.addCommand("  Show in Flow", "LGA_showInlFlow.main()", "ctrl+shift+e", shortcutContext=2, icon=icon_RnW)
...
n.addCommand("  Rotate - Left (0.1)", "LGA_rotateShortcuts.increment_rotate(0.1)", "Ctrl+/", icon=icon_RT)
n.addCommand("  Rotate - Left (1)", "LGA_rotateShortcuts.increment_rotate(1)", "Ctrl+Shift+/", icon=icon_RT)
n.addCommand("  Rotate - Right (-0.1)", "LGA_rotateShortcuts.increment_rotate(-0.1)", "Ctrl+*", icon=icon_RT)
n.addCommand("  Rotate - Right (-1)", "LGA_rotateShortcuts.increment_rotate(-1)", "Ctrl+Shift+*", icon=icon_RT)
...
n.addCommand("  Paste To Selected", "pasteToSelected.pasteToSelected()", "ctrl+shift+v", shortcutContext=2, icon=icon_CnP)



# Importar cargar el duplicateWithInputs
import duplicateWithInputs
n.addCommand("  Copy with inputs", "duplicateWithInputs.copyWithInputs()", "ctrl+alt+c", shortcutContext=2, icon=icon_CnP)
n.addCommand("  Paste with inputs", "duplicateWithInputs.pasteWithInputs()", "ctrl+alt+v", shortcutContext=2, icon=icon_CnP)
n.addCommand("  Duplicate with inputs", "duplicateWithInputs.duplicateWithInputs()", "ctrl+alt+k", shortcutContext=2, icon=icon_CnP)
...
n.addCommand("  Viewer Rec709", "LGA_viewerRec709.main()", "shift+v", shortcutContext=2, icon=icon_VA)



# Shortcut para Reset Workspace
n.addCommand("  Reset Workspace", "import hiero; hiero.ui.resetCurrentWorkspace()", "ctrl+alt+w", icon=icon_VA)
...
n.addCommand("  Restart NukeX", "LGA_restartNukeX.check_and_exit(1)", "ctrl+alt+shift+Q", icon=icon_VA)
