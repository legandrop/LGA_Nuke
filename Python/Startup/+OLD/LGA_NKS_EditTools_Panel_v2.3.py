...
__________________________________________________
  ...
  LGA_EditToolsPanel v2.5 - 2024 - Lega Pugliese
...
class ReconnectMediaWidget(QWidget):
    def __init__(self):
        ...
        self.buttons = [
            ("Organize Project", self.organizer.organize_project, "#532b2b"),
            ("Clean Project", self.clean_project, "#532b2b"),
            ("Rec709 | Clip", self.rec709_clip, "#3e513a"),
            ("Default | Clip", self.default_clip, "#3e513a"),
            ("Refresh Timeline", self.refresh_timeline, "#4a3753"),
            ("Set Shot Name", self.set_shot_name, "#14345e"),
            ("Extend &Edit", self.extend_edit_to_playhead, "#14345e", "Alt+E", "Alt+E"),
            ("Reconnect T > N", self.reconnect_t_to_n, "#5f4f14"),
            ("Reconnect N > T", self.reconnect_n_to_t, "#5f4f14"),
            ("Reconnect Media", self.reconnectMediaFromTimeline, "#5f4f14", "Alt+M", "Alt+M"),
            ]
