...
____________________________________________________________________________________
  ...
  LGA_NKS_Flow_Panel v2.1 - 2024 - Lega Pugliese
        ...
        try:
            ...
            if os.path.exists(script_path):
                try:
                    ...
                    module = importlib.util.module_from_spec(spec)
                    spec.loader.exec_module(module)
                    result = module.Push_Task_Status(button_name, base_name)
                    ...
                    if not isinstance(item, hiero.core.EffectTrackItem):
                        ...
                        if item.source().mediaSource().isMediaPresent():
                            ...
                            try:
                                ...
                                push_result = self.push_task_status(button_name, base_name)
                                if push_result:
                                    # Solo cambiar el color si el push fue exitoso
                                    if active_version:
