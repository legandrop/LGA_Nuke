...
_________________________________________________
  ...
  LGA_RevToolsPanel v2.0 - 2024 - Lega Pugliese
    ...
    def reveal_in_explorer(self):
        try:
            ...
            if len(selected_clips) == 0:
                ...
                for shot in selected_clips:
                    if isinstance(shot, hiero.core.EffectTrackItem):  # Verificar si es un efecto
                        #debug_print(f"Ignore effect item: {item.name()}")
                        pass  
                    else:
...
##### Reveal 
    def reveal_project(self):
        ...
        if project:
            ...
            debug_print("El directorio del proyecto activo es:", project_path)
            ...
            if len(selected_clips) == 0:
                ...
                for shot in selected_clips:
                    if isinstance(shot, hiero.core.EffectTrackItem):  # Verificar si es un efecto
                        ...
                        debug_print("Project path:", project_path)
