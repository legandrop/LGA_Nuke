...
____________________________________________________________________________
  ...
  LGA_NKS_Flow_Pull v1.9 - 2024 - Lega Pugliese
                    ...
                    if isinstance(clip, hiero.core.EffectTrackItem):  # Verificar si es un efecto
                        ...
                        if shot:
                            ...
                            if task:
                                ...
                                debug_print(f"sg_description before assignee: {sg_description}")

                                # Obtener el nombre del asignado si existe
                                assignee = task.get('task_assigned_to', 'No assignee')
                                debug_print(f"Assignee: {assignee}")
                                sg_description = f"{sg_description}\nAssignee: {assignee}"

                                debug_print(f"sg_description after assignee: {sg_description}")
                                ...
                                if change or sg_version_number > version_number:
                                    ...
                                    if sg_version_number > version_number:
                                        ...
                                        if sg_version_number > new_version_number:
                                            self.add_custom_tag_to_clip(clip, "Version Mismatch", f"SG Version: {sg_version_str}", "icons:TagRed.png")
