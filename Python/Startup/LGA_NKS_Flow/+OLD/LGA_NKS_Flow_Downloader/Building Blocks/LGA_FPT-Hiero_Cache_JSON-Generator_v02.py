...
def main():
    ...
    for project_name in project_names:
        ...
        shots = sg_downloader.find_project_shots(project_name)
        ...
        for shot in shots:
            ...
            tasks = sg_downloader.find_tasks_for_shot(shot['id'])
            ...
            for task in tasks:
                if 'Comp' in task['content']:
                    ...
                    versions = sg_downloader.find_versions_for_shot(shot['id'])
