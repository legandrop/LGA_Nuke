...
def main():
    ...
    download_thread = threading.Thread(target=download_project_data, args=(sg_downloader, project_names, json_SG_output_file))
    download_thread.start()
    
    # Mientras se ejecuta el hilo de descarga, imprimir puntitos en el hilo principal
