...
class SyncApp:
    ...
    def settings_window(self):
       ### Ventana que muestra cuantas versiones nuevas hay
        ...
        # Crear y empacar los Entry widgets para los proyectos
        self.project_vars = [tk.StringVar(value=name) for name in self.project_names[:4]]  # Solo toma los primeros cuatro elementos
        for i, var in enumerate(self.project_vars, start=1):
            project_entry = ctk.CTkEntry(projects_frame, textvariable=var, width=300)
            project_entry.pack(fill=ctk.X, expand=True, padx=(20, 20), pady=(5, 5))
        ...
        ok_project_button = ctk.CTkButton(project_button_frame, text="OK", width=20)
