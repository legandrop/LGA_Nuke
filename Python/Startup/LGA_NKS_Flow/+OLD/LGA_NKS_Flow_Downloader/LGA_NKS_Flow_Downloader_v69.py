...
class ShotGridManager:
    ...
    def __init__(self, file_path):
        ...
        with open(file_path, 'r') as file:
            ...
            self.data = loaded_data['projects']  # Accediendo al nivel 'project'
...
class HieroOperations:
    ...
    def process_all_shots(self, output_file):
        ...
        # Carga la configuracion y extrae el nombre del proyecto
        config = load_config()
        project_names = config.get('project_names', ['DefaultProjectName'])  # Usar un valor predeterminado si no se encuentra
        
        shots = self.sg_manager.find_project_shots(project_names)
        project_data = {
