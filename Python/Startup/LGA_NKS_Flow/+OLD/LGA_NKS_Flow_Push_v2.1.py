...
_____________________________________________________________
  ...
  LGA_NKS_Flow_Push v1.9 - 2024 - Lega Pugliese
...
class ShotGridManager:
    ...
    def add_comment_to_version(self, version_id, project_id, comment, user_id, shot_id=None):
        try:
                    ...
                    if sg_status == "rev_di" or sg_status == "corr":
                        ...
                        try:
                            if self.message:
                                ...
                                self.sg_manager.add_comment_to_version(sg_highest_version['id'], project_id, self.message, user_id, shot['id'])
                        except Exception as e:
