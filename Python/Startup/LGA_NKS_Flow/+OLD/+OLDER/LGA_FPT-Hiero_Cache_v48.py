...
class HieroOperations:
    ...
    def uploaded_versions_window(self, versions):
        ...
        details_window.title("Version Details")
        ...
        set_title_bar_color(details_window, BG_Color, TXT_Color)  # Set title bar color        
        ...
        label = ctk.CTkLabel(container_frame, text="New versions pulled:", text_color=TXT_Color, anchor="w")
        label.pack(padx=10, pady=(10, 0), fill="x")
        ...
        for version in versions:
            version_label = ctk.CTkLabel(scrollable_frame, text=version, wraplength=scrollable_frame.winfo_width() - 20)
            version_label.pack(padx=10, pady=5, fill="x")
