...
class SyncApp:
    ...
    def setup_system_tray(self):
        ...
        # Configura el menu con una accion por defecto para clic derecho
    ...
    def recreate_tray_icon(self):
        if hasattr(self, 'tray_icon'):
            self.tray_icon.stop()  # Detiene el icono anterior si existe
        self.tray_icon = pystray.Icon("SyncApp", self.icon_image, "SyncApp", self.menu)
        self.tray_icon.run()  # Inicia el icono del tray
    ...
    def on_minimize(self, event=None):
        ...
        self.recreate_tray_icon()  # Asegura la creacion y ejecucion del icono en el tray


    def show_window(self, icon, item):
        self.root.deiconify()  # Mostrar la ventana
        self.root.lift()       # Traer la ventana al frente
        self.root.focus_force()  # Forzar el foco a la ventana
        if hasattr(self, 'tray_icon'):
            self.tray_icon.stop()  # Detiene el icono del tray
