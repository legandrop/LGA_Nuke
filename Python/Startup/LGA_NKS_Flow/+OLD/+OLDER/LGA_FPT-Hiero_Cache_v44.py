...
BG_Color = "#1b1b1b"  # Background color
...
class HieroOperations:
    ...
    def show_initial_dialog(self, versions):
        ...
        icon_path = resource_path("iconos.ico")
    ...
    def show_uploaded_versions(self, versions):
        ...
        icon_path = resource_path("iconos.ico")  # Obtener la ruta del icono
...
class SyncApp:
    ...
    def create_widgets(self):
        ...
        self.interval_option = ctk.CTkOptionMenu(control_frame, values=["1", "15", "30", "60"], command=self.on_interval_change, width=60)
        ...
        custom_font = ctk.CTkFont(family="Roboto", size=16, weight="bold")

        # Boton Sync Now
        self.sync_now_button = ctk.CTkButton(self.root, text="Sync Now", command=self.sync_now, width=60)
        self.sync_now_button.configure(font=custom_font)  # Aplicar la fuente personalizada al boton
