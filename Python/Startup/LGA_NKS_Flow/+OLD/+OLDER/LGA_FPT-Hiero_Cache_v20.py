...
class SyncApp:
    ...
    def sync_now(self):
        # Ejecutar la tarea de sincronizacion inmediatamente
        self.job()
    ...
    def start_sync(self):
        ...
        if not self.running:
            ...
            self.scheduler_thread.daemon = True  # Hacer el hilo un daemon
    ...
    def on_closing(self):
        if self.running:
            self.running = False  # Senaliza a los hilos que deben detenerse
            schedule.clear()  # Limpia cualquier tarea programada
