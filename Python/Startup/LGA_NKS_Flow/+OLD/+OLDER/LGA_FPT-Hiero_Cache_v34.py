...
class CustomToplevel(tk.Toplevel):
    def __init__(self, master=None, **kwargs):
        ...
        # Cambiar el comando del boton de cerrar para que llame a on_closing()
        ...
        self.minimize_button = ttk.Button(self.titlebar, text='-', command=self.minimize)
        self.minimize_button.pack(side=tk.RIGHT, padx=5, pady=5)

        self.title_label = ttk.Label(self.titlebar, text='', background='#333333', foreground='white', font=('Arial', 12))
        self.title_label.pack(side=tk.LEFT, padx=10)

        self.titlebar.bind('<Button-1>', self.click_window)
    ...
    def minimize(self):
        self.attributes('-alpha', 0.0)  # Solo un ejemplo, puede requerir ajustes para macOS
