...
class HieroOperations:
    ...
    def new_versions_window(self, versions):
        ...
        details_button = ctk.CTkButton(button_frame, text="Details",
                                        command=lambda: [dialog.destroy(), self.show_uploaded_versions(versions)], width=60)
    ...
    def adjust_window_size(self, window):
        ...
        width = window.winfo_reqwidth()  # Ancho requerido
        height = window.winfo_reqheight()  # Altura requerida
