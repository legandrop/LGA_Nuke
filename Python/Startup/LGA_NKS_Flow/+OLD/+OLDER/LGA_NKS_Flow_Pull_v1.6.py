...
____________________________________________________________________________
  ...
  LGA_NKS_Flow_Pull v1.6 - 2024 - Lega Pugliese
...
class ShotGridManager:
    ...
    def __init__(self, json_path):
        ...
        self.task_status_dict = {
            ...
            'ready': ('Ready To Start', '#f9da00', None),
            ...
            if selected_clips:
                ...
                for clip in selected_clips:
                    if isinstance(clip, hiero.core.EffectTrackItem):  # Verificar si es un efecto
                        ...
                        print(f"Ruta base del shot: {shot_base_path}")
...
def tag_shot_folder(shot_base_path, tag):
    ...
    try:
        ...
        if hwnd:
            ...
            if result:
                print(f"Tag '{tag}' applied to {shot_base_path}")
            else:
                print(f"Failed to apply tag '{tag}' to {shot_base_path}")
        else:
            print("XYplorer window not found.")
    except Exception as e:
        print(f"Error applying tag in XYplorer: {e}")
