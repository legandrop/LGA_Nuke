...
class GUI_Table(QWidget):
    ...
    def initUI(self):
        ...
        HieroOperations.load_data(self.table)
...
class HieroOperations:
    ...
    def load_data(table):
        ...
        table.setItem(row_count, 0, QTableWidgetItem("EHQALPV_001_010_SombraOvni_Aparece_comp_v05"))
        table.setItem(row_count, 1, QTableWidgetItem("Comp"))
        table.setItem(row_count, 2, QTableWidgetItem("In Progress"))
        table.setItem(row_count, 3, QTableWidgetItem("Corrections"))
