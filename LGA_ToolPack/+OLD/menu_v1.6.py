...
n.addCommand('  Media Path Replacer', "LGA_mediaPathReplacer.show_search_replace_widget()", 'ctrl+alt+m', shortcutContext=2)


# Importar el LGA_mediaMissingFrames
import LGA_mediaMissingFrames 
n.addCommand('  Media Missing Frames', "LGA_mediaMissingFrames.main()", 'ctrl+alt+shift+m', shortcutContext=2)
...
n.addCommand ('  Reload all Reads', 'LGA_reloadAllReads.reload_all_read_nodes()', 'ctrl+alt+shift+r', shortcutContext=2)
...
n.addCommand('  Rename Writes from Reads', 'LGA_renameWritesFromReads.renameWrite()', 'F2', shortcutContext=2)


# Importar el LGA_ocio_RnW
import LGA_ocio_RnW 
n.addCommand('  OCIO Output Transform', "LGA_ocio_RnW.main()", 'shift+o', shortcutContext=2)
...
n.addCommand('  Read -> FrameRange', 'LGA_fr_Read_to_FrameRange.set_frame_range_from_read()', 'ctrl+alt+f', shortcutContext=2)
...
n.addCommand('  Read -> Project', 'LGA_fr_Read_to_Project.main()', 'shift+f', shortcutContext=2)


# Importar el LGA_fr_TimeClip_to_Write
import LGA_fr_TimeClip_to_Write
n.addCommand('  TimeClip -> Write', 'LGA_fr_TimeClip_to_Write.set_write_from_timeclip()', 'ctrl+t', shortcutContext=2)
