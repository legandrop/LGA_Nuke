...
m = nuke.menu('Nuke')
m = m.findItem('TP')  
m.addCommand('  Media Path Replacer', "LGA_mediaPathReplacer.show_search_replace_widget()", 'ctrl+alt+m', shortcutContext=2)
...
m = nuke.menu('Nuke')
m = m.findItem('TP')
m.addCommand('  Media Missing Frames', "LGA_mediaMissFrames.main()", 'ctrl+alt+shift+m', shortcutContext=2)
...
m = nuke.menu('Nuke')
n = m.addMenu('TP')
n.addCommand ('  Read from Write', 'readFromWrite.ReadFromWrite()', 'shift+r', shortcutContext=2)
...
m = nuke.menu('Nuke')
n = m.addMenu('TP')
n.addCommand('  Write Send Mail', 'add_send_mail_to_all_writes()', 'shift+w', shortcutContext=2)
...
m = nuke.menu('Nuke')
n = m.addMenu('TP')
n.addCommand ('  Reload all Reads', 'LGA_reloadReads.reload_all_read_nodes()', 'ctrl+alt+shift+r', shortcutContext=2)
...
m = nuke.menu('Nuke')
m = m.findItem('TP')
n.addCommand('  Reveal in Explorer', "LGA_revealExplorer.LGA_revealExplorer()", 'shift+e', shortcutContext=2)
...
m = nuke.menu('Nuke')
m = m.findItem('TP')
n.addCommand('  Reveal in Flow', "LGA_revealFlow.main()", 'ctrl+shift+e', shortcutContext=2)
...
m = nuke.menu('Nuke')
n = m.findItem('TP')
n.addCommand('  Rename Writes from Reads', 'LGA_renameWrite.renameWrite()', 'F2', shortcutContext=2)
...
m = nuke.menu("Nuke")
n = m.addMenu("TP")
n.addCommand('  Frame Range | Read -> FrameRange', 'LGA_FrameRangeFromRead.set_frame_range_from_read()', 'ctrl+alt+f', shortcutContext=2)
...
m = nuke.menu("Nuke")
n = m.addMenu("TP")
n.addCommand('  Frame Range | Read -> Write', 'LGA_writeFrameRange_Read.Writes_FrameRange()')
...
m = nuke.menu("Nuke")
n = m.addMenu("TP")
n.addCommand('  Frame Range | Read -> Project', 'LGA_projectFrameRange_Read.main()', 'shift+f', shortcutContext=2)
...
m = nuke.menu("Nuke")
n = m.addMenu("TP")
n.addCommand('  Frame Range | TimeClip -> Write', 'LGA_writeFrameRange_TimeClip.set_write_from_timeclip()', 'ctrl+t', shortcutContext=2)
...
m = nuke.menu('Nuke')
m = m.findItem('TP')
n.addCommand('  Rec709 | Viewer', "LGA_viewerRec709.main()", 'shift+v', shortcutContext=2)
...
m = nuke.menu("Nuke")
n = m.addMenu("TP")
n.addCommand("  Rotate - Left (0.1)", "LGA_rotateShortcuts.increment_rotate(0.1)", "Ctrl+/")
n.addCommand("  Rotate - Left (1)", "LGA_rotateShortcuts.increment_rotate(1)", "Ctrl+Shift+/")
n.addCommand("  Rotate - Right (-0.1)", "LGA_rotateShortcuts.increment_rotate(-0.1)", "Ctrl+*")
n.addCommand("  Rotate - Right (-1)", "LGA_rotateShortcuts.increment_rotate(-1)", "Ctrl+Shift+*")
...
m = nuke.menu("Nuke")
n = m.addMenu('TP') 
n.addCommand('  Switch Merge Ops', 'LGA_switchMergeOperations.update_merge_operations()', 'shift+m', shortcutContext=2)

# Importar cargar el PasteToSelected
import pasteToSelected
m = nuke.menu("Nuke")
n = m.addMenu('TP') 
n.addCommand('  Paste To Selected', 'pasteToSelected.pasteToSelected()', 'ctrl+shift+v', shortcutContext=2)
...
m = nuke.menu("Nuke")
n = m.addMenu('TP') 
n.addCommand('  Copy with inputs', 'duplicateWithInputs.copyWithInputs()', 'ctrl+alt+c', shortcutContext=2)
n.addCommand('  Paste with inputs', 'duplicateWithInputs.pasteWithInputs()', 'ctrl+alt+v', shortcutContext=2)
n.addCommand('  Duplicate with inputs', 'duplicateWithInputs.duplicateWithInputs()', 'ctrl+alt+k', shortcutContext=2)


# Shortcut para Reset Workspace
m = nuke.menu('Nuke')
n = m.addMenu('TP') 
n.addCommand('  Reset Workspace', 'import hiero; hiero.ui.resetCurrentWorkspace()', 'ctrl+alt+w')
