...
copy "LGA_ToolPack-B\LGA_ToolPack-B.pdf" .

rem Crear el archivo zip con las exclusiones especificadas y el archivo PDF en la raíz
"C:\Program Files\7-Zip\7z.exe" a -tzip "%DESTINO%\!NEWZIPNAME!" LGA_ToolPack-B\* LGA_ToolPack-B.pdf -xr@LGA_ToolPack-B\+exclude.lst

rem Eliminar el archivo PDF temporal de la carpeta actual
del LGA_ToolPack-B.pdf
